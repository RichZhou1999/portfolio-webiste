(function(g){var window=this;'use strict';var Ldb=function(a){g.W.call(this,{G:"div",K:"ytp-miniplayer-ui"});this.Mf=!1;this.player=a;this.S(a,"minimized",this.Jh);this.S(a,"onStateChange",this.KN)},Mdb=function(a){g.bR.call(this,a);
this.u=new g.MF(this);this.j=new Ldb(this.player);this.j.hide();g.tQ(this.player,this.j.element,4);a.cg()&&(this.load(),g.mo(a.getRootNode(),"ytp-player-minimized",!0));this.player.N("web_rounded_containers")&&g.mo(a.getRootNode(),"ytp-rounded-miniplayer",!0)};
g.v(Ldb,g.W);g.k=Ldb.prototype;
g.k.TK=function(){this.tooltip=new g.hV(this.player,this);g.H(this,this.tooltip);g.tQ(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Nc=new g.VR(this.player);g.H(this,this.Nc);this.Wi=new g.W({G:"div",K:"ytp-miniplayer-scrim"});g.H(this,this.Wi);this.Wi.Ca(this.element);this.S(this.Wi.element,"click",this.RF);var a=new g.W({G:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.sN()]});g.H(this,a);a.Ca(this.Wi.element);this.S(a.element,"click",this.Bo);
a=new g.x2(this.player,this);g.H(this,a);a.Ca(this.Wi.element);this.Ut=new g.W({G:"div",K:"ytp-miniplayer-controls"});g.H(this,this.Ut);this.Ut.Ca(this.Wi.element);this.S(this.Ut.element,"click",this.RF);var b=new g.W({G:"div",K:"ytp-miniplayer-button-container"});g.H(this,b);b.Ca(this.Ut.element);a=new g.W({G:"div",K:"ytp-miniplayer-play-button-container"});g.H(this,a);a.Ca(this.Ut.element);var c=new g.W({G:"div",K:"ytp-miniplayer-button-container"});g.H(this,c);c.Ca(this.Ut.element);this.QU=new g.BT(this.player,
this,!1);g.H(this,this.QU);this.QU.Ca(b.element);b=new g.zT(this.player,this);g.H(this,b);b.Ca(a.element);this.nextButton=new g.BT(this.player,this,!0);g.H(this,this.nextButton);this.nextButton.Ca(c.element);this.Zi=new g.VU(this.player,this);g.H(this,this.Zi);this.Zi.Ca(this.Wi.element);this.Hc=new g.MT(this.player,this);g.H(this,this.Hc);g.tQ(this.player,this.Hc.element,4);this.HF=new g.W({G:"div",K:"ytp-miniplayer-buttons"});g.H(this,this.HF);g.tQ(this.player,this.HF.element,4);a=new g.W({G:"button",
Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.sN()]});g.H(this,a);a.Ca(this.HF.element);this.S(a.element,"click",this.Bo);a=new g.W({G:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"Close"},W:[g.zN()]});g.H(this,a);a.Ca(this.HF.element);this.S(a.element,"click",this.B4);this.S(this.player,"presentingplayerstatechange",this.qd);this.S(this.player,"appresize",this.Bb);this.S(this.player,"fullscreentoggled",this.Bb);this.Bb()};
...
g.k.B4=function(){this.player.playVideo()};
...
g.k.tq=function(){};
g.k.FD=function(){};
g.k.lr=function(){};g.v(Mdb,g.bR);g.k=Mdb.prototype;g.k.onVideoDataChange=function(){if(this.player.N("web_rounded_containers")&&this.player.getVideoData()){var a=16/9;a=this.player.getVideoAspectRatio()>a+.1;g.mo(this.player.getRootNode(),"ytp-rounded-miniplayer-extra-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.aR("miniplayer",Mdb);})(_yt_player);
